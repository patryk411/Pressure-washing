                ...
                <div id="carouselExampleInterval" class="carousel slide" data-bs-ride="carousel">
                  <div class="carousel-inner">
                    <div class="carousel-item active" data-bs-interval="2000">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/mycie1.jpg" class="" alt="...">
                    </div>
                    <div class="carousel-item" data-bs-interval="5000">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/mycie2.jpg" class="" alt="...">
                    </div>
                    <div class="carousel-item" data-bs-interval="8000">
                      <img src="<?php echo get_template_directory_uri(); ?>/img/mycie3.jpg" class="" alt="...">
                    </div>
              </div>
